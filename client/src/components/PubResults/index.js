        ...
        <div className="col-sm-12">
          <div className="panel panel-info">
                  ...
                  <div style={{ flex: '0 1 80%' }}>
                    ...
                    <IconHelp initial={false}>
                      <div className="well well-sm">
                        Search results from the FlyBase bibliography database
                        may include papers or reviews, but other publication
                        types are excluded here. Papers available for annotation{' '}
                  ...
                  <div>
                    ...
                    <IconHelp initial={false} btnClasses="pull-right">
                      <div className="well well-sm" style={{ clear: 'both' }}>
                        ...
                        publication in the search results has already been
                        annotated by FlyBase curators, or by other Fast-Track
                        contributors. Publications which have already been
                        curated cannot be selected for further annotation in the
                        Fast-Track Your Paper tool.
                        <br />
                        If you would like to suggest changes to the annotations
                        on a paper which has already been curated, please{' '}
            ...
            <div className="panel-footer small">
              ...
              please check back again soon; the Fast-Track database is updated
              weekly.
            </div>
          </div>{' '}
          {/* end .panel */}
